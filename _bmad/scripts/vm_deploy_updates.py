...
# Copy new migration
local_dir = f"{LOCAL_PATH}/prisma/migrations/20260522080458_add_is_issued_to_laptop"
remote_dir = f"{VM_PATH}/prisma/migrations/20260522080458_add_is_issued_to_laptop"
try:
    sftp.mkdir(remote_dir)
except:
    pass
...
# Build takes a while, just check if it finished
print("Build output length:", len(out))
if "error" in out.lower()[-2000:]:
    print("Possible build error:", out[-2000:])
else:
    print("Build seems OK")
